import './styles.scss';
import lavinia1 from '../../assets/images/foto-lavinia1.png';

export default function About() {
    return (
        <section id='about' className='d-flex row'> 
            <div className='col col-12 col-lg-6 d-flex flex-column'>
            ...
            <div className='col col-12 col-lg-5 d-flex flex-column'>
                <h2>Sobre mim:</h2>
                <p className='abocut-p'>
            ...
            <div className='col col-12 col-md-6 d-flex flex-column justify-content-center align-items-center'>
                <img 
                    className='w-75 d-block d-lg-none my-5'
                    src={lavinia1}
                    alt="" 
                />
            </div>
        <div id='small-box' className='d-flex row justify-content-evenly align-items-top'>
            <div className='d-none d-lg-block col col-4 text-center small-box' id='mission'>
                <h3>Missão</h3>
                <p>
            ...
            <div className='d-none d-lg-block col col-4 text-center small-box' id='vision'>
                <h3>Visão</h3>
                <p>
                    Ser referência na reabilitação ortopédica e traumatológica na minha região.
                </p>
            </div>
            <div className='d-none d-lg-block col col-4 text-center small-box' id='values'>
                <h3>Valores</h3>
                <p>
